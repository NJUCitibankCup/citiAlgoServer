...
#------------------------------------------------------
PATH = "/home/rex/workspace/Bank/src/a_2010.csv"
PRICE_DATA_RANGE = (652, 894)
PRICE_DATA_COLUMN = 8
#------------------------------------------------------
...
#------------------------------------------------------
INTERVAL_DIVIDER_O = 11 #!!!!!!
INTERVAL_DIVIDER_AB = 6 #!!!!!!
GAP_DIVIDER_O = 11 #!!!!!!
GAP_DIVIDER_AB = 6 #!!!!!!
#------------------------------------------------------
...
gap_o = mp.Value('i', interval_o.value // NUM_O) #!!!!!!
gap_ab = mp.Value('i', interval_ab.value // NUM_AB) #!!!!!!
...
def producer():
    ...
    while 1:
        ...
        event_start_produce.clear() #!!!!!! moved from back to top
        ...
        interval_o.value //= INTERVAL_DIVIDER_O #!!!!!!
        interval_ab.value //= INTERVAL_DIVIDER_AB #!!!!!!

        gap_o.value = max(gap_o.value // GAP_DIVIDER_O, 1) #!!!!!!
        gap_ab.value = max(gap_ab.value // GAP_DIVIDER_AB, 1) #!!!!!!
...
def subscriber_consumer2():
    ...
    while 1:
        ...
        if target_set[1] > history_large_set[1]: #!!!!!!
        	...
        	queue_toproduce.put(history_large_set) #!!!!!!
...
def estimate_args():
    ...
    consumer_1 = [mp.Process(target=calculator_consumer) for i in range(4)]
    ...
    print(expect_sigmma_t(result_o.value/1e9, result_a.value/1e6, result_b.value/1e6, sigmma_n=3, t_in_year=20/252))
